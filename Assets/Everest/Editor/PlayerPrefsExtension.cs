...
namespace Everest {
    //https://www.programmersought.com/article/89655388313/

    [Serializable]
    internal struct PlayerPrefPair {
        public string Key { get; set; }

        public object Value { get; set; }
    }

    internal static class PlayerPrefsExtension {
        ...
        public static PlayerPrefPair[] GetAll(string companyName, string productName) {
            if (Application.platform == RuntimePlatform.OSXEditor) {
                ...
                if (File.Exists(playerPrefsPath)) {
                    ...
                    //Đoạn này đang thiếu thư viện https://github.com/animetrics/PlistCS
                    throw new Exception("thiếu thư viện https://github.com/animetrics/PlistCS");
